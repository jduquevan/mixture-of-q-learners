...
BASE_PYTHON_COMMAND = "python purejaxql/pqn_atari_grad_accum.py" \
            " RUN_ID={run_id}" \
            ...
            " alg.GRAD_ACCUM_STEPS={grad_accum_steps}" \
...
def get_jobs():
    jobs = {
        ...
        'gravitar_pqn_atari_400x400_512envs_0136eps_ACCUMX2': get_job(env_name='Gravitar-v5', num_envs=512, img_size=400, total_timesteps=25e7, eps_finish=0.0136, scale_factor=1, grad_accum_steps=2),
    }
