...
def get_jobs():
    jobs = {
        'montezuma_ngu_400x400_512envs_0136eps': get_job(env_name='MontezumaRevenge-v5', num_envs=512, img_size=400, total_timesteps=25e7, eps_finish=0.0136),
        'pitfall_ngu_400x400_512envs_0136eps': get_job(env_name='Pitfall-v5', num_envs=512, img_size=400, total_timesteps=25e7, eps_finish=0.0136),
