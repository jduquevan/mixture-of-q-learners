...
def get_jobs():
    jobs = {
        'pqn_atari_84x84_512envs': get_job(num_envs=512, img_size=84, total_timesteps=25e7, eps_finish=0.001),
        'pqn_atari_400x400_512envs': get_job(num_envs=512, img_size=400, total_timesteps=25e7, eps_finish=0.001),
        'pqn_atari_84x84_128envs': get_job(num_envs=128, img_size=84, total_timesteps=25e7, eps_finish=0.001),
        'pqn_atari_400x400_512env_0136eps': get_job(num_envs=512, img_size=400, total_timesteps=25e7, eps_finish=0.0136),
        'pqn_atari_84x84_512envs_0136eps': get_job(num_envs=512, img_size=84, total_timesteps=25e7, eps_finish=0.0136),
    }
