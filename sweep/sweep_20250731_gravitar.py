...
### Jobs ###
BASE_RUN_ID = "20250731_gravitar_0dot136eps_finish_v2"
...
def get_jobs():
    jobs = {
        ...
        'gravitar_depth_exploration': get_job(mix_num_agents=2,
                                              num_envs=128,
                                              buffer_per_agent=128,
                                              img_size=84,
                                              mix_num_updates=1,
                                              ...
                                              big_mid_rounds_dont_fill_buffer=True,
                                              double_big_mid_num_envs=True, 
                                              big_mid_rounds_exploration_eps_scheduler="depth_exploration_0.1_U0.3"
                                              ),
        
        'gravitar_depth_exploration_longer': get_job(mix_num_agents=2,
                                              num_envs=128,
                                              buffer_per_agent=128,
                                              img_size=84,
                                              mix_num_updates=1,
                                              mix_num_updates_decay=1,
                                              big_mid_rounds_num_updates=40000, 
                                              big_mid_rounds_num_updates_decay=400,
                                              mq_rounds=1,
