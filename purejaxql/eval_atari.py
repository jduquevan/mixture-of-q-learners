...
import numpy as np
import envpool
from di_atari import JaxLogEnvPoolWrapper, Transition, compute_agent_metrics, eps_greedy_exploration, QNetwork
...
def single_run(config):
    ...
    obs, metrics = jax.jit(make_eval(config, num_envs=25, num_steps=config["VIDEO_STEPS"], return_obs=True))(ckpt_params, ckpt_batch_stats, rng)
