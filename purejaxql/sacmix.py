...
def create_agent(env, network, config, lr, rng):
    ...
    actor_state  = ActorState.create(
        ...
        params    = params_actor,
        batch_stats = variables['batch_stats'],
        log_tau   = variables['params']['log_tau'],
        tx        = tx_actor,
    )
    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            def _step_env(carry, _):
                ...
                new_action = jax.vmap(jax.vmap(lambda logit, key: jax.random.categorical(key, logit)))(logits, _rngs)
            ...
            log_tau_batch = jnp.repeat(actor_train_states.log_tau, config["NUM_ENVS"])
